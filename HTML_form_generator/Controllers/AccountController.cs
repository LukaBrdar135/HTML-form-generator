    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var fromAddress = new MailAddress("projekat.ppp@gmail.com", "HTML form generator");
                var toAddress = new MailAddress(user.Email, user.FirstName);
                const string fromPassword = "projekat123";
        ...
        public ActionResult DeleteAccount()
        {
            ...
            List<CodeHistory> codeHistories = _context.CodeHistories.Where(c => c.UserId == user.Id).ToList();
            ...
            TempData["success"] = "Successfully deleted account";
